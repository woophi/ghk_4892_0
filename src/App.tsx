...
export const App = () => {
  ...
  const ideasInView = useInViewGAEvent('4892_show_ideas1_var1');
  const ideas2InView = useInViewGAEvent('4892_show_ideas2_var1');
  const dfaInView = useInViewGAEvent('4892_show_dfa_var1');
  const calendarInView = useInViewGAEvent('4892_show_calendar1_var1');
  const crowdInView = useInViewGAEvent('4892_show_crowd_var1');
  const meshInView = useInViewGAEvent('4892_show_list1_var1');
  const featureInView = useInViewGAEvent('4892_show_feature_var1');
  ...
  return (
    <>
      ...
      <Swiper style={{ marginLeft: '1rem' }} spaceBetween={8} slidesPerView="auto">
        ...
        >
          <MeshContent
            eventName="4892_show_list2_var1"
        ...
        >
          <MeshContent
            eventName="4892_show_list3_var1"
        ...
        >
          <MeshContent
            eventName="4892_show_list4_var1"
...
const StrategySlideContent = ({ item, itemIndex }: { item: (typeof firstSliderData)[0]; itemIndex: number }) => {
  const itemInView = useInViewGAEvent(`4892_show_strategy${itemIndex + 1}_var1`);
...
const CalendarSlideContent = ({ item, itemIndex }: { item: (typeof secondSliderData)[0]; itemIndex: number }) => {
  const itemInView = useInViewGAEvent(`4892_show_calendar${itemIndex + 2}_var1`);
...
const PlacesSlideContent = ({ item, itemIndex }: { item: (typeof thirdSliderData)[0]; itemIndex: number }) => {
  const itemInView = useInViewGAEvent(`4892_show_razm${itemIndex + 1}_var1`);
